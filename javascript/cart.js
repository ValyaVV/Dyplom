...
const addToCartBtns = document.querySelectorAll('.button_add')
...
function updateCartUI(){
    ...
    for(const [key, value] of items.entries()){
        ...
        <img src="${value.img}" > 
                       <div class="details">
                           <h3>${value.name}</h3>
                           <p>${value.desc}
                            <span class="quantity">Кількість: ${value.quantity}</span>
                               <span class="price">Вартість: $ ${price}</span>
                           </p>
                       </div>
    ...
    if(count > 0){
        ...
        subtotal.innerHTML = `Кінцева сумма: $${total}`
    }
    else
